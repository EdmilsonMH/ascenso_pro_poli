...
/// Usado en pestana_estudio, pantalla_preguntas_acertadas, pantalla_preguntas_incorrectas
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Checkbox para todas las materias
          CheckboxListTile(
            value:
                widget.todasLasMaterias.isNotEmpty &&
                _materiasSeleccionadas.length == widget.todasLasMaterias.length,
            onChanged: (bool? value) {
              setState(() {
                if (value == true) {
                  _materiasSeleccionadas = List.from(widget.todasLasMaterias);
                } else {
